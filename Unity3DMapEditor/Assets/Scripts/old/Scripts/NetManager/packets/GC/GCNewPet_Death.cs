...
{
	public class GCNewPet_Death :  PacketBase
	{
		//公用继承接口
		...
		public override short getPacketID() { return (short)PACKET_DEFINE.PACKET_GC_NEWPET_DEATH; }
	...
	public class GCNewPet_DeathFactory :  PacketFactory 
	{
		public override PacketBase CreatePacket() { return new GCNewPet_Death() ; }
        public override int GetPacketID() { return (int)PACKET_DEFINE.PACKET_GC_NEWPET_DEATH; }
