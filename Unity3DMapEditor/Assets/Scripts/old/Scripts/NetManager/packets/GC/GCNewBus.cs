...
{
	public class GCNewBus : PacketBase
	{
        public override short getPacketID()
        {
            return (short)PACKET_DEFINE.PACKET_GC_NEWBUS;
        }
    ...
    public class GCNewBusFactory : PacketFactory
    {
        public override PacketBase CreatePacket() { return new GCNewBus(); }
        public override int GetPacketID() { return (int)PACKET_DEFINE.PACKET_GC_NEWBUS; }
