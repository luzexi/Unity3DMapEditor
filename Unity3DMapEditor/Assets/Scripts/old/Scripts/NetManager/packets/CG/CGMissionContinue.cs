...
{
    public class CGMissionContinue : PacketBase
    {
        public override short getPacketID()
        {
            return (short)PACKET_DEFINE.PACKET_CG_MISSIONCONTINUE;
        }
    ...
    public class CGMissionContinueFactory : PacketFactory
    {
        public override PacketBase CreatePacket() { return new CGMissionContinue(); }
        public override int GetPacketID() { return (int)PACKET_DEFINE.PACKET_CG_MISSIONCONTINUE; }
